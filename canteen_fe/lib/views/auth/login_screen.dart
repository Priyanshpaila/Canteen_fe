...
import 'package:canteen_fe/views/auth/signup_screen.dart';
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
                        ...
                        children: [
                          ...
                          _LabeledField(
                            ...
                            child: TextField(
                              ...
                              keyboardType:
                                  TextInputType
                                      .number, // ensures numeric keypad on mobile
                          ...
                          // PIN (6 digits, numeric, visibility toggle)
                          _LabeledField(
                            label: "PIN",
                            child: TextField(
                              focusNode: _pinFocus,
  ...
  // Input decoration with soft fill & subtle borders
  ...
  // Decorative blurred blob for subtle background depth
...
/// A soft, elegant card with subtle neumorphic-like shadows.
...
/// Label above field for a clean, professional form look
